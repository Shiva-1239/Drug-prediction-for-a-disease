...
def drugPred():
    ...
    elif(logitdisease == "Hypertension" or svcdisease == "Hypertension"):
        t6.insert(END,tension)
    elif(logitdisease == "Allergy" or svcdisease == "Allergy"):
        t6.insert(END,allergy)
    elif(logitdisease == "Fungal Infection" or svcdisease == "Fungal Infection"):
        t6.insert(END,fungal)
    elif(logitdisease == "GERD" or svcdisease == "GERD"):
        t6.insert(END,gerd)
    elif(logitdisease == "Chronic cholestasis" or svcdisease == "Chronic cholestasis"):
        t6.insert(END,chronic)
    elif(logitdisease == "Drug Reaction" or svcdisease == "Drug Reaction"):
        t6.insert(END,Drug)
    #elif(logitdisease == "Peptic ulcer disease" or svcdisease == "Peptic ulcer disease"):
        #t6.insert(END,peptic)
    else:
...
# Heading
w2 = Label(root, justify=LEFT, text="Drug  Prediction for Diseases using Machine Learning", fg="white", bg="grey")
w2.config(font=("Elephant", 25))
w2.grid(row=1, column=0, columnspan=2, padx=100)
w2 = Label(root, justify=LEFT, text="", fg="white", bg="grey")
...
log = Label(root, text="Disease 1", fg="black", bg="white")
log.grid(row=15, column=0, pady=10, sticky=W)

svc = Label(root, text="Disease 2", fg="black", bg="white")
svc.grid(row=16, column=0, pady=10, sticky=W)

dp = Label(root, text="Drug Prediction", fg="black", bg="white")
...
logit = Button(root, text="LogisticRegression", command=LogisticRegression,bg="white",fg="green")
logit.grid(row=8, column=3,padx=10)

svm = Button(root, text="SupportVectorMachine", command=SVC,bg="white",fg="green")
svm.grid(row=9, column=3,padx=10)

dpt = Button(root, text="Drug Prediction", command=drugPred,bg="white",fg="green")
...
t4 = Text(root, height=1, width=40,bg="white",fg="blue")
t4.grid(row=15, column=1 , padx=10)

t5 = Text(root, height=1, width=40,bg="white",fg="blue")
t5.grid(row=16, column=1 , padx=10)

t6 = Text(root, height=2, width=40,bg="white",fg="blue")
